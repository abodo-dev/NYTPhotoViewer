...
- (void)setupMediaOverlayView
{
  ...
  CGFloat newX = (self.contentSize.width / 2) - (self.mediaOverlayView.frame.size.width / 2);
  CGFloat newY = (self.contentSize.height / 2) - (self.mediaOverlayView.frame.size.height / 2);
